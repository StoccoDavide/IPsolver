...
if BUILD_TESTS then
  cmd_cmake_build += "-DIPSOLVER_BUILD_TESTS:VAR=true "
else
  cmd_cmake_build += "-DIPSOLVER_BUILD_TESTS:VAR=false "
end
if BUILD_EXAMPLES then
  cmd_cmake_build += "-DIPSOLVER_BUILD_EXAMPLES:VAR=true "
else
  cmd_cmake_build += "-DIPSOLVER_BUILD_EXAMPLES:VAR=false "
end
if BUILD_DEBUG then
...
task :build_gen do
  ...
  puts "run CMake for IPsolver".yellow
  sh cmd_cmake + ' ..'
  puts "compile with CMake for IPsolver".yellow
  if BUILD_DEBUG then
