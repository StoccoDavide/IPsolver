function(parse_version_string VERSION_STRING)
  ...
  set(IPSOLVER_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(IPSOLVER_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(get_version_from_git)
  ...
  set(IPSOLVER_VERSION "0.0.0" CACHE INTERNAL "")
  set(IPSOLVER_VERSION_PRERELEASE "" CACHE INTERNAL "")
endfunction()

function(write_version_file)
  if(NOT IPSOLVER_VERSION)
    message(FATAL_ERROR "IPSOLVER_VERSION is not set")
  endif()

  set(VERSION_STRING "${IPSOLVER_VERSION}")
  if(IPSOLVER_VERSION_PRERELEASE)
    set(VERSION_STRING "${VERSION_STRING}-${IPSOLVER_VERSION_PRERELEASE}")
  endif()
